...
--Utils.LUA_DEBUGOUT("Default_land" .. "TechFolderOrder")
	local laArray = {
		'infantry_folder', 
		'industry_folder',
...
--Utils.LUA_DEBUGOUT("Default_land" .. "voTechnologyData")
...
--Utils.LUA_DEBUGOUT("Default_land" .. "ProductionWeights")
	local laArray = {
		0.70, -- Land
		0.20, -- Air
		0.0, -- Sea
...
--Utils.LUA_DEBUGOUT("Default_land" .. "LandRatio")
	return Prod_Land.RatioGenerator(voProductionData)
end
function P.SpecialForcesRatio(voProductionData)
--Utils.LUA_DEBUGOUT("Default_land" .. "SpecialForcesRatio")
	local laRatio = {
		40, -- Land
...
--Utils.LUA_DEBUGOUT("Default_land" .. "EliteUnits")
...
--Utils.LUA_DEBUGOUT("Default_land" .. "FirePower")
	local laArray = {"infantry_brigade"};
		
	return laArray
end
function P.AirRatio(voProductionData)
--Utils.LUA_DEBUGOUT("Default_land" .. "AirRatio")
	return Prod_Air.RatioGenerator(voProductionData)
end
function P.RocketRatio(voProductionData)
--Utils.LUA_DEBUGOUT("Default_land" .. "RocketRatio")
	local laArray = {
		10, -- Air
		1} -- Bomb/Rockety
...
--Utils.LUA_DEBUGOUT("Default_land" .. "NavalRatio")
	return Prod_Sea.RatioGenerator(voProductionData)
end
function P.TransportLandRatio(voProductionData)
--Utils.LUA_DEBUGOUT("Default_land" .. "TransportLandRatio")
	local laArray = {
		0, -- Land
		0,  -- transport
		0}  -- invasion craft
...
--Utils.LUA_DEBUGOUT("Default_land" .. "ConvoyRatio")
	local laArray = {
...
--Utils.LUA_DEBUGOUT("Default_land" .. "Build_infantry_brigade")
