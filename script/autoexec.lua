...
package.path = package.path .. ";tfh\\mod\\WW1Mod_v0.98\\script\\?.lua"
package.path = package.path .. ";tfh\\mod\\WW1Mod_v0.98\\script\\country\\?.lua"
package.path = package.path .. ";tfh\\mod\\WW1Mod_v0.98\\script\\diplomacy\\?.lua"
package.path = package.path .. ";tfh\\mod\\WW1Mod_v0.98\\script\\intelligence\\?.lua"
package.path = package.path .. ";tfh\\mod\\WW1Mod_v0.98\\script\\politics\\?.lua"
package.path = package.path .. ";tfh\\mod\\WW1Mod_v0.98\\script\\production\\?.lua"
package.path = package.path .. ";tfh\\mod\\WW1Mod_v0.98\\script\\utilities\\?.lua"
