...
military = {
	...
	DIG_IN_FACTOR = 0.05,	-- dig-in factor.
	...
	MINIMUM_STRENGTH = 80,		--minimum strength of a land division at production.  50 = 5000 men.
	BRIGADES_IN_DIVISION = 3,	--number of allowed brigades in a division.
	...
	NAVAL_STACK_POS_HULL_LIMIT = 32,		-- Total Hull size up to this is fine before taking stacking penalty
	NAVAL_STACK_POS_PENALTY_HULL_MULT = 0.02, 	-- Every hull point above the limit gives this positioning penalty
	NAVAL_STACK_POS_PENALTY_MAX = 0.99, -- maximum possible penalty due to size/positioning
	...
	UNIT_UPGRADE_COST = 0.1, -- was 0.1 and before was 0.5
	UNIT_UPGRADE_TIME = 0.1,
	UNIT_UPGRADE_PRACTICAL_MOD = 0.4, -- smaller value gives less practical on upgrade
...
diplomacy = {
	...
	EXPEDITION_RETURN_TIME = 2.0,
	EXPEDITION_RECLAIM_TIME = 2.0,
