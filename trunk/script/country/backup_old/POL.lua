...
function P.Build_Fort(ic, voProductionData)
	if voProductionData.Year <= 1939 then
		...
		ic = Support.Build_Fort(ic, voProductionData, 2040, 10) -- Lódz
		...
		ic = Support.Build_Fort(ic, voProductionData, 2509, 2) -- Lwów
		ic = Support.Build_Fort(ic, voProductionData, 2445, 2) -- Kraków
	end
