...
function ProductionMinister_Tick(minister)
	...
	if not (ProductionData.ManpowerMobilize) then
	...
	if ProductionData.ManpowerMobilize and ProductionData.icAvailable > 0.1 then
		...
		if tostring(ProductionData.ministerTag) == "ENG" then
			--Utils.LUA_DEBUGOUT("Potential ICs Country: " .. tostring(ProductionData.ministerTag) .. ", LAND = " .. tostring(ProductionData.icAllocated * laProdWeights[1]).. ", Air = " .. tostring(ProductionData.icAllocated * laProdWeights[2]).. ", Sea = " .. tostring(ProductionData.icAllocated * laProdWeights[3]).. ", Other = ".. tostring(ProductionData.icAllocated * laProdWeights[4]))
		end
		...
		if tostring(ProductionData.ministerTag) == "ENG" then
			--Utils.LUA_DEBUGOUT("Needed ICs Country: " .. tostring(ProductionData.ministerTag) .. ", LAND = " .. tostring(liNeededLandIC).. ", Air = " .. tostring(liNeededAirIC).. ", Sea = " .. tostring(liNeededNavalIC).. ", Other = ".. tostring(liNeededOtherIC))
		end
		...
		if tostring(ProductionData.ministerTag) == "ENG" then
			--Utils.LUA_DEBUGOUT("Post Norm Needed ICs Country: " .. tostring(ProductionData.ministerTag) .. ", LAND = " .. tostring(liNeededLandIC).. ", Air = " .. tostring(liNeededAirIC).. ", Sea = " .. tostring(liNeededNavalIC).. ", Other = ".. tostring(liNeededOtherIC))
		end
		-- Process Land Units
		...
		if tostring(ProductionData.ministerTag) == "ENG" then
			--Utils.LUA_DEBUGOUT("Post air check Needed ICs Country: " .. tostring(ProductionData.ministerTag) .. ", LAND = " .. tostring(liNeededLandIC).. ", Air = " .. tostring(liNeededAirIC).. ", Sea = " .. tostring(liNeededNavalIC).. ", Other = ".. tostring(liNeededOtherIC))
		end
		...
		if tostring(ProductionData.ministerTag) == "ENG" then
			--Utils.LUA_DEBUGOUT("Got Through Land")
		end
		...
		if tostring(ProductionData.ministerTag) == "ENG" then
			--Utils.LUA_DEBUGOUT("Got Through Air")
		end
		...
		if tostring(ProductionData.ministerTag) == "ENG" then
			--Utils.LUA_DEBUGOUT("Got Through A")
		end
		...
		--if tostring(ProductionData.ministerTag) == "GER" then
			--Utils.LUA_DEBUGOUT("Got Through B")
		--end
		...
		--if tostring(ProductionData.ministerTag) == "GER" then
			--Utils.LUA_DEBUGOUT("Post Alloc Needed ICs Country: " .. tostring(ProductionData.ministerTag) .. ", LAND = " .. tostring(liNeededLandIC).. ", Air = " .. tostring(liNeededAirIC).. ", Sea = " .. tostring(liNeededNavalIC).. ", Other = ".. tostring(liNeededOtherIC))
			--Utils.LUA_DEBUGOUT("IC Available: " .. tostring(ProductionData.icAvailable) .. ", Trying Naval")
		--end
		-- Build Naval Units
		...
		--if tostring(ProductionData.ministerTag) == "GER" then
			--Utils.LUA_DEBUGOUT("IC Available: " .. tostring(ProductionData.icAvailable) .. ", Trying Air")
		--end
		...
		--if tostring(ProductionData.ministerTag) == "GER" then
			--Utils.LUA_DEBUGOUT("IC Available: " .. tostring(ProductionData.icAvailable) .. ", Trying Land")
		--end
		...
		--if tostring(ProductionData.ministerTag) == "GER" then
			--Utils.LUA_DEBUGOUT("IC Available: " .. tostring(ProductionData.icAvailable) .. ", Trying Buildings")
		--end
		...
		--if tostring(ProductionData.ministerTag) == "GER" then
			--Utils.LUA_DEBUGOUT("IC Available: " .. tostring(ProductionData.icAvailable) .. ", Trying Last Chance")
		--end
		...
		--if tostring(ProductionData.ministerTag) == "GER" then
			--Utils.LUA_DEBUGOUT("IC Available: " .. tostring(ProductionData.icAvailable) .. ", After Last Chance")
		--end
